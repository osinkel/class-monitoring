...
urlpatterns = [
    ...
    path('teachers/delete/<int:pk>/', views.TeacherDeleteView.as_view(), name='teacher_delete'),
    path('teachers/update/<int:pk>/', views.TeacherUpdateView.as_view(), name='teacher_update'),
